...
const Nav = () => {
    return (
        <nav role="navigation" className="invisible md:z-50 md:visible w-full bg-green-900 text-green-50 fixed flex justify-center">
                ...
                <div className="list-none flex justify-center items-center gap-x-8 text-xs opacity-80 font-medium xl:text-sm xl:gap-x-12 xl:pl-10">
                    <div className="inline-block relative">
                        <li className="relative">
                            <Link href="/dashboard" className="inline-block h-full w-full">Dashboard</Link>
                        </li>
                    </div>
                    <div className="inline-block relative">
                        <li className="relative">
                            <Link href="/season" className="inline-block h-full w-full">Season Rewards</Link>
                        </li>
                    </div>
                    <div className="inline-block relative">
                        <li className="relative">
                            <Link href="/celebrate" className="inline-block h-full w-full">Celebrate</Link>
                        </li>
                    </div>
                </div>
                {/* social items */}
