            ...
            <div className="list-none flex flex-col justify-center items-center gap-y-5 text-2xl pb-3">
                <div className="inline-block relative">
                    <li className="relative">
                        <a href="/dashboard" className="inline-block h-full w-full" onClick={props.select}>Dashboard</a>
                    </li>
                </div>
                <div className="inline-block relative">
                    <li className="relative">
                        <a href="/season" className="inline-block h-full w-full" onClick={props.select}>Season Rewards</a>
                    </li>
                </div>
                <div className="inline-block relative">
                    <li className="relative">
                        <a href="/celebrate" className="inline-block h-full w-full" onClick={props.select}>Celebrate</a>
                    </li>
                </div>
            </div>
            {/* social items */}
