...
const MobileMenu = (props) => {
    ...
    return (
        <div className="flex z-0 flex-col bg-green-900 text-green-50 h-screen items-center justify-center gap-y-8" role="mobile menu" >
            {/* logo */}
            ...
            <div className="list-none flex flex-col justify-center items-center gap-y-5 text-2xl pb-3">
                <div className="inline-block relative">
                    <li className="relative">
                        <Link href="/dashboard" className="inline-block h-full w-full" onClick={props.select}>Dashboard</Link>
                    </li>
                </div>
                <div className="inline-block relative">
                    <li className="relative">
                        <Link href="/season" className="inline-block h-full w-full" onClick={props.select}>Season Rewards</Link>
                    </li>
                </div>
                <div className="inline-block relative">
                    <li className="relative">
                        <Link href="/celebrate" className="inline-block h-full w-full" onClick={props.select}>Celebrate</Link>
                    </li>
                </div>
            </div>
            {/* social items */}
